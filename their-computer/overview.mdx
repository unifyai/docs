...
is a separate topic: assistants can't see or touch your machine unless you
explicitly link it, and by default the closest they get is watching your
screen share on a call and talking you through the steps. As the assistant
itself puts it:
