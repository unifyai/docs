...
<img className="block dark:hidden" src="/images/developers/dev-computer-control-stack-light.svg" alt="The computer control stack" />
<img className="hidden dark:block" src="/images/developers/dev-computer-control-stack-dark.svg" alt="The computer control stack" />
...
<img className="block dark:hidden" src="/images/developers/dev-desktop-lifecycle-light.svg" alt="Managed desktop lifecycle" />
<img className="hidden dark:block" src="/images/developers/dev-desktop-lifecycle-dark.svg" alt="Managed desktop lifecycle" />
...
<img className="block dark:hidden" src="/images/developers/dev-screen-share-flow-light.svg" alt="Screen share and remote control flow" />
<img className="hidden dark:block" src="/images/developers/dev-screen-share-flow-dark.svg" alt="Screen share and remote control flow" />
