...
you'll see **one tab** (`tab1`) and **two tiles** (`Table` left and `View` right).
...
<picture>
    ...
    <img class="dark-light" width="100%" src="https://raw.githubusercontent.com/unifyai/unifyai.github.io/refs/heads/main/img/externally_linked/interface_light.png"/>
</picture>
