...
Rather than going through each concept in detail, we explain interfaces through a collection of simple examples for different applications of **logging**, **debugging**, **evaluating**, and **interaction**. This is by no means an exhaustive list (you can build an interface for pretty much *anything*), but it should give you an idea of how flexible and hackable interfaces are 🛠️
