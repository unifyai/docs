...
This avoids the need to make any real LLM calls, saving time and money,
...
Let's wrap our system message template in a simple function to populate the template variables with the specific data involved,
...
and new logs will simply be added without deleting any prior logs.
