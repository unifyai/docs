...
```python
def upload(overwrite=False) -> Dataset
```
...
```python
def download(overwrite=False) -> Dataset
```
...
```python
def add(other: Union[Dataset, str, Dict, Prompt, Datum,
...
```python
def sub(other: Union[Dataset, str, Dict, Prompt, Datum,
                     List[Union[str, Dict, Prompt, Datum]]])
```
...
```python
def __iadd__(other: Union[Dataset, str, Dict, Prompt, Datum,
                          List[Union[str, Dict, Prompt, Datum]]])
```
...
```python
def __isub__(other: Union[Dataset, str, Dict, Prompt, Datum,
                          List[Union[str, Dict, Prompt, Datum]]])
```
