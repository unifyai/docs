...
```python
def __init__(data: Union[str, Dict, Prompt, DatasetEntry,
...
```python
def add(other: Union[Dataset, str, Dict, Prompt, DatasetEntry,
                     List[Union[str, Dict, Prompt, DatasetEntry]]])
```
...
```python
def sub(other: Union[Dataset, str, Dict, Prompt, DatasetEntry,
                     List[Union[str, Dict, Prompt, DatasetEntry]]])
```
...
```python
def __iadd__(other: Union[Dataset, str, Dict, Prompt, DatasetEntry,
                          List[Union[str, Dict, Prompt, DatasetEntry]]])
```
...
```python
def __isub__(other: Union[Dataset, str, Dict, Prompt, DatasetEntry,
                          List[Union[str, Dict, Prompt, DatasetEntry]]])
```
