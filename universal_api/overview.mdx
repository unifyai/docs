...
The rest of the docs assume you're using **Python**,
but this is all built on top of our [REST API](https://docs.unify.ai/api-reference),
which you can query directly.
...
We won't show any more `curl` examples, but you can check out the
