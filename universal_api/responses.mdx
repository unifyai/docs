...
from the perspective of *evaluations*, which is why we omit it. If desired, you can view
the full `ChatCompletion` instance (in the same indented manner) like so:
