...
Teams. Once it's installed, every assistant in the org — and your T-W1N — is
reachable through it; there's nothing to configure per assistant.

## Messaging

- **1:1 chat** — message the Unify app in Teams and your T-W1N, the
  coordinator that fields anything unaddressed, picks up the conversation.
...
- In a **channel or group chat**, @mention the app and include the teammate's
  ...
  @mention it with no name and the message goes to your **T-W1N**, who can
  hand off from there.
- In a **1:1 chat**, messages go to your T-W1N — there's no name to add, so
  naming a teammate isn't used here.
