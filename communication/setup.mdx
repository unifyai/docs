...
<AccordionGroup>
  ...
  <Accordion title="Slack">
    Choose **Add to Slack** and authorize the Unify app. You connect a
    workspace **once** for the whole account or organization — every
    assistant becomes reachable through it, and you address a specific one
    by naming it in the mention. Only the account owner, or an org owner or
    admin, can connect it. See [Slack](/communication/slack).
  </Accordion>
  <Accordion title="Microsoft Teams">
    Nothing to create per assistant — a Microsoft admin installs the Unify
    Teams app once for the organization and every assistant is reachable
    through it. See [Microsoft Teams](/communication/microsoft-teams). (An
    assistant can also act through its *own* Microsoft 365 account instead;
    that's part of the [workspace connection](/workspace/teams).)
  </Accordion>
</AccordionGroup>
...
| Discord | Yes | Yes |
| Email | Free | Free |
| Slack & Microsoft Teams | Free | Free |
