...
<ParamField body="unique_id_column" type="boolean"  default="false">
Whether to create a unique, sequential ID for each log in this context.
</ParamField>

<ParamField body="unique_id_names" type="string | array"  default="row_id">
Name(s) of the unique ID column(s). Can be a string for a single column or a list for nested unique IDs.
</ParamField>
...
json_input = {"name": "experiment1/trial1", "description": "Context for experiment 1 trial 1", "is_versioned": True, "allow_duplicates": True, "unique_id_names": ["task_id", "instance_id"]}
