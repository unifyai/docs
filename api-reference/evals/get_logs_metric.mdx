...
```bash cURL
curl --request GET \
  --url 'https://api.unify.ai/v0/logs/metric/mean/score?project=eval-project&filter_expr=len(output)%20>%20200%20and%20temperature%20==%200.5&from_ids=[0,%201,%202]&exclude_ids=[0,%201,%202]' \
