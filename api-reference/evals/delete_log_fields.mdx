...
api: 'DELETE /v0/logs/field/{field}'
---
...
<ParamField query="field" type="string" required="true">
Name of the field to delete from the given logs. This can be a param or an entry
</ParamField>
...
```bash cURL
curl --request DELETE \
  --url 'https://api.unify.ai/v0/logs/field/entry-v0' \
