...
```bash cURL
curl --request GET \
  --url 'https://api.unify.ai/v0/logs/latest_timestamp?project=eval-project&context=subjects/science/physics&filter_expr=len(output)%20>%20200%20and%20temperature%20==%200.5&sorting={'score':%20'ascending',%20'timestamp':%20'descending'}&limit=None&offset=None' \
