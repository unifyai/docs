---
title: "List all voices for the user and global presets"
api: 'GET /v0/assistant/voice'
---
Returns a list of all voices created or registered by the user, and all globally registered preset voices.
