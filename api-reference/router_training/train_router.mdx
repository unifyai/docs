...
```bash cURL
curl --request POST \
  --url 'https://api.unify.ai/v0/router/train?name=my_router&dataset=dataset1&prompts=34,89,127&endpoints=['gpt-4o-mini@openai',%20'claude-3.5-sonnet@anthropic',%20'llama-3.1-405b-chat@fireworks-ai']' \
