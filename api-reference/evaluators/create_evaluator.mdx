...
<ParamField body="response_parser" type="object | null"  default={{"assistant_response": "['message']['content']"}}>
...
json_input = {"name": "eval1", "judge_models": "claude-3.5-sonnet@aws-bedrock"}
