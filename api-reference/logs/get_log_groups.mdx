...
```bash cURL
curl --request GET \
  --url 'https://api.unify.ai/v0/logs/groups?project_name=eval-project&key=system_prompt&context=training&filter_expr=len(output)%20>%20200%20and%20temperature%20==%200.5&from_ids=0&1&2&exclude_ids=0&1&2' \
