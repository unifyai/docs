...
Dictionary mapping field names to their descriptions (or None if no description).
</ParamField>
...
json_input = {"project": "eval-project", "context": "experiment1/trial1", "fields": {"score": "Evaluation score"}}
