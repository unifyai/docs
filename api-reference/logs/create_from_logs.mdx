...
json_input = {"project_name": "eval-project", "context": "experiment1/trial1", "key": "score_diff", "equation": "{log0:score} - {log1:score}", "referenced_logs": {"log0": [0, 1, 2], "log1": {"filter_expr": "score > 0.5"}}, "derived": False}
