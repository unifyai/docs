...
json_input = {"project_name": "eval-project", "context": "experiment1/trial1", "target_derived_logs": {"log0": [0, 1, 2], "log1": {"filter_expr": "derived_score > 0.5"}}, "key": "temp_plus_20", "equation": "{t:temperature} + 20", "referenced_logs": {"other": {"filter_expr": "score > 0.5"}, "t": [1, 2, 3]}}
