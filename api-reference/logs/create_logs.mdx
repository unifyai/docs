...
<ParamField body="recompute_derived" type="boolean"  default="false">
If True, recompute derived columns for the newly created logs using active ActiveDerivedLog templates. Suitable for small batches; for large ingestion workflows, leave False and rely on periodic backfill.
</ParamField>
...
json_input = {"project_name": "eval-project", "context": "experiment1/trial1"}
