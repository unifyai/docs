...
<ParamField body="delete_empty_columns" type="boolean"  default={true}>
Whether to delete columns that have no data after log deletion.
</ParamField>
...
json_input = {"project": "eval-project", "context": "experiment1/trial1", "ids_and_fields": [[123, "score"], [[456, 457], ["score", "response"]], [[458, 459, 460], "response"], [{"score": "100"}, None], [None, "score"]], "source_type": "all", "delete_empty_logs": True, "delete_empty_columns": True}
