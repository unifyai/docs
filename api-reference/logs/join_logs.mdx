...
<ParamField body="columns" type="array | null" >
...
json_input = {"pair_of_args": [{"context": "context_a", "filter_expr": "user_id == 1"}, {"context": "context_b", "filter_expr": "user_id == 2"}], "join_expr": "A.user_id == B.user_id", "mode": "inner", "new_context": "Derived/A_B", "columns": ["A.user_id", "B.score"]}
