...
canvas views](/canvas/overview), credentials — lives in a **memory pool**.
...
| **Data & canvas** | Your scratch analysis | The ops board everyone checks at standup |
...
- The team's ops view is fed by team data tables that any member's
